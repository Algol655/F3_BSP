...
//acc_orientation[1] = 'w';		//LSM6DS3 accelerometer Y axis orientation
  ...
  gyro_orientation[0] = 'n';	//Gyro X axis orientation
//gyro_orientation[1] = 'w';	//LSM6DS3 gyro Y axis orientation
  gyro_orientation[1] = 'e';	//LSM9DS1 gyro Y axis orientation
  gyro_orientation[2] = 'u';	//Gyro Z axis orientation

  mag_orientation[0] = 'n';		//Magnetometer X axis orientation
//mag_orientation[1] = 'e';		//LSM303AGR magnetometer Y axis orientation
  mag_orientation[1] = 'w';		//LSM9DS1 magnetometer Y axis orientation
  mag_orientation[2] = 'u';		//Magnetometer Z axis orientation
...
//BSP_SENSOR_MAG_GetOrientation(ipKnobs->mag_orientation);
  ...
  ipKnobs->LMode = 1;			//Gyroscope bias learning mode; 0=learning off, 1=static learning, 2=dynamic learning
  ipKnobs->modx = DECIMATION;

  ipKnobs->start_automatic_gbias_calculation = 1;	//Restarts gyroscope bias calibration when set to 1

  MotionFX_setKnobs(mfxstate, ipKnobs);

  MotionFX_enable_6X(mfxstate, MFX_ENGINE_DISABLE);
  MotionFX_enable_9X(mfxstate, MFX_ENGINE_ENABLE);		//Start Enabled. Modified By Me!!!
}
