...
extern volatile uint32_t HCI_ProcessEvent;	//Added By Me!!
...
void hci_tl_lowlevel_init(void)
{
  ...
  HAL_NVIC_SetPriority(EXTI4_IRQn, 3, 0);	//Modified By Me!!!
...
void hci_tl_lowlevel_isr(void)
{
  ...
  while(IsDataAvailable())
  {
    ...
    {
      HCI_ProcessEvent=1;		//Added By Me!!!
      return;
    }
  }
